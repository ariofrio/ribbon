...
Deferred turns a dashed ring. Blocked's slash now spans only the width of
Completed's dot. Threads saved as Active return to Idle, and stage automation is
gone.
